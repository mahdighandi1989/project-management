...
export const projectDetailHelp: PageHelp = {
  ...
  elements: [
    ...
    },
    {
      id: 'tab-inspector',
      title: 'تب بازرس ویژه',
      description: 'ابزار پیشرفته برای بازرسی و تحلیل عمیق پروژه. شامل اسکرین پیش‌نمایش بزرگ (840px) با نشانگر موس مجازی، چت هوشمند با انتخاب خودکار مدل، دسترسی به GitHub و همکاری چند مدل AI.',
      type: 'tab',
      tips: [
        ...
        '🆕 نشانگر موس مجازی: حرکت و کلیک روی صفحه',
    ...
    },
    {
      ...
      description: 'نمایشگر افقی بزرگ (840px عرض) با نسبت 1.82:1 برای پیش‌نمایش زنده پروژه. شامل نشانگر موس مجازی که حرکات AI را نشان می‌دهد.',
      type: 'panel',
      tips: [
        'فرانت‌اند در iframe لود می‌شود',
        'لاگ‌های بک‌اند با 30% شفافیت در پس‌زمینه',
        '🆕 نشانگر موس مجازی: نشان‌دهنده محل کلیک AI',
        '🆕 نام مدل AI کنار نشانگر نمایش داده می‌شود',
        '🆕 افکت کلیک با انیمیشن',
    ...
    {
      id: 'inspector-virtual-cursor',
      title: '🆕 نشانگر موس مجازی',
      description: 'نشانگر موس قرمز رنگ که حرکات و کلیک‌های AI را روی صفحه پیش‌نمایش نشان می‌دهد.',
      type: 'area',
      tips: [
        'شکل نشانگر موس قرمز',
        'نام مدل AI کنار نشانگر نمایش داده می‌شود',
        'افکت کلیک با انیمیشن',
        'حرکت نرم بین نقاط',
        'پس از 3 ثانیه خودکار پنهان می‌شود'
      ],
    },
    {
