...
export const projectDetailHelp: PageHelp = {
  ...
  elements: [
    ...
    },
    {
      id: 'tab-inspector',
      title: 'تب بازرس ویژه',
      description: 'ابزار پیشرفته برای بازرسی و تحلیل عمیق پروژه. شامل اسکرین پیش‌نمایش بزرگ (840px) و چت با دستیار هوشمند. سرویس‌های Render را لود می‌کند و لاگ‌ها را نمایش می‌دهد.',
      type: 'tab',
      tips: [
        'اسکرین سمت چپ برای پیش‌نمایش پروژه (1.5 برابر بزرگتر)',
        'چت با دستیار بازرس برای تحلیل',
        'دکمه‌های سریع: تحلیل کد، بررسی امنیت، یافتن باگ',
        'URL واقعی سرویس از Render API دریافت می‌شود',
        'سرویس‌های یکپارچه (فرانت+بک) پشتیبانی می‌شوند'
      ],
    },
    {
      id: 'inspector-screen',
      title: 'اسکرین پیش‌نمایش',
      description: 'نمایشگر افقی بزرگ (840px عرض) با نسبت 1.82:1 برای پیش‌نمایش زنده پروژه. فرانت‌اند در iframe لود می‌شود و لاگ‌های بک‌اند با شفافیت در پس‌زمینه نمایش داده می‌شوند.',
      type: 'panel',
      tips: [
        'فرانت‌اند در iframe لود می‌شود',
        'لاگ‌های بک‌اند با 30% شفافیت در پس‌زمینه',
        'برای سرویس‌های یکپارچه (فرانت+بک) همان URL برای هر دو استفاده می‌شود',
        'URL واقعی از Render API (serviceDetails.url) دریافت می‌شود',
        'Fallback: اگر URL نداشت، از slug ساخته می‌شود'
      ],
    },
    {
      id: 'inspector-chat',
      title: 'چت دستیار بازرس هوشمند',
      description: 'پنل چت با مدل‌های AI (380px عرض). مدل‌ها به تمام داده‌های پروژه دسترسی دارند: لاگ‌ها، فایل‌ها، URL فرانت‌اند.',
      type: 'panel',
      tips: [
        'همه مدل‌های AI صفحه مدل‌ها در دسترس هستند',
        'امکان انتخاب یک یا چند مدل همزمان',
        'مدل‌ها به لاگ‌های بک‌اند دسترسی دارند',
        'مدل‌ها به URL فرانت‌اند دسترسی دارند',
        'مدل‌ها به فایل‌های پروژه دسترسی دارند',
        'تاریخچه چت حفظ می‌شود',
    ...
    },
    {
      ...
      description: 'انتخاب مدل‌های AI برای چت. همه مدل‌های فعال از صفحه مدل‌ها در اینجا قابل انتخاب هستند.',
      type: 'select',
      tips: [
        'کلیک روی چرخ‌دنده در هدر چت',
        'مدل‌های سفید = انتخاب شده',
        'مدل‌های خاکستری = غیرفعال',
        'می‌توانید چند مدل انتخاب کنید',
        'پاسخ همه مدل‌ها به صورت جداگانه نمایش داده می‌شود'
      ],
    },
    {
      id: 'inspector-ai-context',
      title: 'Context مدل‌های AI',
      description: 'داده‌هایی که به مدل‌های AI ارسال می‌شوند برای تحلیل پروژه.',
      type: 'section',
      tips: [
