...
export const projectDetailHelp: PageHelp = {
  ...
  elements: [
    ...
    },
    {
      ...
      description: 'نمایشگر افقی با ابعاد 5.8 اینچ (5.1" x 2.8") برای پیش‌نمایش زنده پروژه. فرانت‌اند در داخل اسکرین و لاگ‌های بک‌اند در پس‌زمینه نمایش داده می‌شوند.',
      type: 'panel',
      tips: ['فرانت‌اند در iframe لود می‌شود', 'لاگ‌های بک‌اند با شفافیت در پس‌زمینه', 'برای سرویس‌های یکپارچه (فرانت+بک) همان URL برای هر دو استفاده می‌شود'],
    },
    {
      id: 'inspector-chat',
    ...
    },
    {
      ...
      tips: [
        ...
        'سرویس‌های یکپارچه (فرانت+بک) هم برای پیش‌نمایش و هم برای لاگ استفاده می‌شوند'
      ],
    },
    {
      id: 'btn-upload',
