...
export const projectDetailHelp: PageHelp = {
  ...
  elements: [
    ...
    },
    {
      ...
      description: 'پنل گفتگو با دستیار هوشمند بازرس (320px عرض). تحلیل پروژه، یافتن باگ، بررسی امنیت و نمایش خطاهای لاگ.',
      type: 'panel',
      tips: [
        'سوالات خود را درباره پروژه بپرسید',
        'از دکمه‌های سریع استفاده کنید',
        'نتایج تحلیل در چت نمایش داده می‌شود',
        'خطاهای بک‌اند به صورت خودکار در چت نشان داده می‌شوند'
      ],
    },
    {
