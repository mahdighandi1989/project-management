...
export const projectDetailHelp: PageHelp = {
  ...
  elements: [
    ...
    },
    {
      id: 'tab-inspector',
      title: 'تب بازرس ویژه',
      description: 'ابزار پیشرفته برای بازرسی و تحلیل عمیق پروژه. شامل اسکرین پیش‌نمایش بزرگ (840px)، چت هوشمند با انتخاب خودکار مدل، دسترسی به GitHub و همکاری چند مدل AI.',
      type: 'tab',
      tips: [
        '⚠️ قابلیت ناوبری بصری (مثل "برو به X") موقتاً متوقف شده',
        '⚠️ مشکل معماری: iframe و مرورگر Playwright دو instance جدا هستند',
    ...
    },
    {
      ...
      tips: [
        ...
        '⚠️ نشانگر موس و کلیک بصری موقتاً متوقف شده',
    ...
    },
    {
      ...
      title: '⏸️ ناوبری بصری (متوقف شده)',
      description: 'قابلیت دادن دستور بصری مثل "برو به بخش X" که موقتاً متوقف شده است به دلیل محدودیت معماری.',
      type: 'area',
      tips: [
        '⚠️ این قابلیت موقتاً متوقف شده است',
        '❌ مشکل: iframe که کاربر می‌بیند و مرورگر Playwright که عمل می‌کند دو instance جدا هستند',
        '❌ نتیجه: کلیک و هایلایت در مرورگر headless انجام می‌شود نه در صفحه‌ای که کاربر می‌بیند',
        '❌ URL تغییر می‌کند ولی کاربر بازخورد بصری (انیمیشن، هایلایت) نمی‌بیند',
        '✅ راه‌حل آینده: Browser Extension یا CDP Protocol',
        '📝 جزئیات کامل در SYSTEM_REPORT_2026-02-04.md بخش 9'
      ],
    },
    {
