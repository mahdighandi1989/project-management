---
task_id: 1317e3cf-6dc0-4762-90e2-26982d59626b
...
created_at: '2026-05-31T09:08:43.109241+00:00'
updated_at: '2026-06-14T09:41:42.281045+00:00'
target_files:
...
Email sending via SMTP but no attachment handling for task/scan bundles. Missing attachment logic.

🛠 پیشنهاد: if attachment_path: msg.attach(MIMEText(open(attachment_path).read(), 'plain'))
---
[scan #2 at 2026-06-07T09:30:54.233917+00:00]
## 📋 شرح
...
##
---
[scan #3 at 2026-06-14T09:41:42.281033+00:00]
## 📋 شرح
در `backend/app/services/notification_service.py` یک `notify_event` call پیدا شد که اولین پارامتر (event_type) رشته‌ای ساده/مبهم است یا خالی.
...
- `backend/app/services/notification_service.py:935`
...
1. این مورد بررسی و حل شد _(verify: backend_test)_
