...
updated_at: '2026-05-31T09:07:45.314449+00:00'
target_files:
...
1. اگر deep_analysis_service exception بدهد، کاربر event 'error' دریافت می‌کند
2. اگر stream بسته شود، exception بی‌صدا نمی‌میرد
3. لاگ خطا شامل traceback کامل است
