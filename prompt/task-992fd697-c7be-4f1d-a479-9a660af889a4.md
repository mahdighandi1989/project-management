...
updated_at: '2026-05-31T09:07:10.247330+00:00'
target_files:
- backend/app/main.py
---
...
1. درخواست بیش از حد مجاز به یک endpoint (مثلاً 100 در دقیقه) با status 429 رد شود
2. endpoint /analysis/run-stream محدودیت 5 درخواست در دقیقه داشته باشد
3. endpoint /debate/create محدودیت 10 درخواست در دقیقه داشته باشد
4. endpoint /oversight/scan محدودیت 3 درخواست در دقیقه داشته باشد
