...
updated_at: '2026-06-07T09:28:59.471889+00:00'
target_files:
...
3. تلاش برای وارد کردن از URLهای غیرمجاز یا URLهایی که به IPهای خصوصی اشاره دارند، منجر به خطای 400 Bad Request می‌شود. _(verify: static)_
4. تست‌های واحد برای جلوگیری از SSRF اضافه می‌شوند. _(verify: static)_
