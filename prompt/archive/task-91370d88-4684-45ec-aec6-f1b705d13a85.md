---
task_id: 91370d88-4684-45ec-aec6-f1b705d13a85
...
created_at: '2026-05-17T08:43:35.619720+00:00'
updated_at: '2026-06-02T17:52:47.097525+00:00'
archived: true
archived_at: '2026-05-17T11:48:18.027875+00:00'
---
...
---
[scan #2 at 2026-05-17T08:43:35.981934+00:00]
## 📋 شرح
env var `APP_NAME` در `.env`/config تعریف شده ولی در هیچ `os.getenv` یا `process.env` خوانده نمی‌شود.

## 🤔 چرا مهم است
یا (الف) reader حذف شده و باعث config drift می‌شود، یا (ب) leak اطلاعات حساس به repository است (مخصوصاً اگر secret است).

## 🔍 جزئیات
- علت: documented in .env.example/REA
---
[scan #3 at 2026-05-17T08:43:36.154514+00:00]
## 📋 شرح
env var `CORS_ORIGINS` در `.env`/config تعریف شده ولی در هیچ `os.getenv` یا `process.env` خوانده نمی‌شود.
...
---
[scan #4 at 2026-05-17T08:43:36.326398+00:00]
## 📋 شرح
...
- علت: documented in .env.example
---
[scan #5 at 2026-05-17T08:43:36.492525+00:00]
## 📋 شرح
env var `DEBUG` در `.env`/config تعریف شده ولی در هیچ `os.getenv` یا `process.env` خوانده نمی‌شود.

## 🤔 چرا مهم است
یا (الف) reader حذف شده و باعث config drift می‌شود، یا (ب) leak اطلاعات حساس به repository است (مخصوصاً اگر secret است).

## 🔍 جزئیات
- علت: documented in .env.example/README
---
[scan #6 at 2026-05-17T08:43:36.675614+00:00]
## 📋 شرح
env var `HOST` در `.env`/config تعریف شده ولی در هیچ `os.getenv` یا `process.env` خوانده نمی‌شود.
