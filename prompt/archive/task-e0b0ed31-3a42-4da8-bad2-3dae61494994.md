---
task_id: e0b0ed31-3a42-4da8-bad2-3dae61494994
title: notification بدون event_type صریح در oversight.py
...
created_at: '2026-05-15T06:07:23.229355+00:00'
updated_at: '2026-05-20T04:23:37.637870+00:00'
archived: true
...
---
[scan #2 at 2026-05-15T06:07:23.327530+00:00]
## 📋 شرح
در `backend/app/api/routes/simple_projects.py` یک `notify_event` call پیدا شد که اولین پارامتر (event_type) رشته‌ای ساده/مبهم است یا خالی.
...
## 🔍 
---
[scan #3 at 2026-05-15T06:07:23.377808+00:00]
## 📋 شرح
...
## 🔍 جز
---
[scan #4 at 2026-05-15T06:41:01.110892+00:00]
## 📋 شرح
در `backend/app/api/routes/oversight.py` یک `notify_event` call پیدا شد که اولین پارامتر (event_type) رشته‌ای ساده/مبهم است یا خالی.
...
## 🔍 جزئیات
---
[scan #5 at 2026-05-15T06:41:01.170918+00:00]
## 📋 شرح
در `backend/app/api/routes/simple_projects.py` یک `notify_event` call پیدا شد که اولین پارامتر (event_type) رشته‌ای ساده/مبهم است یا خالی.
...
## 🔍 
---
[scan #6 at 2026-05-15T06:41:01.241218+00:00]
## 📋 شرح
در `backend/app/api/routes/notifications.py` یک `notify_event` call پیدا شد که اولین پارامتر (event_type) رشته‌ای ساده/مبهم است یا خالی.
