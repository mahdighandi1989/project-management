---
task_id: 9214af19-5c4f-4eaa-ad69-f461a7664a17
title: 'endpoint بک‌اند بلااستفاده: POST /smart-select'
type: audit
priority: medium
...
created_at: '2026-05-15T06:05:56.820701+00:00'
updated_at: '2026-06-03T17:16:28.630811+00:00'
archived: true
...
---
[scan #2 at 2026-05-15T06:05:56.940254+00:00]
## 📋 شرح
...
---
[scan #3 at 2026-05-15T06:05:57.073306+00:00]
## 📋 شرح
...
- علت: no frontend fetch + n
---
[scan #4 at 2026-05-15T06:05:57.659906+00:00]
## 📋 شرح
endpoint `POST /select-model` در `backend/app/api/routes/orchestrator.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
- علت: no frontend fetch +
---
[scan #5 at 2026-05-15T06:39:19.994535+00:00]
## 📋 شرح
endpoint `POST /smart-select` در `backend/app/api/routes/models.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
---
[scan #6 at 2026-05-15T06:39:20.089874+00:00]
## 📋 شرح
endpoint `POST /capability-test-all` در `backend/app/api/routes/models.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
1. مشخص شد endpoint `POST /smart-select` در کدام دسته است (orphan/internal/deprecated) _(verify: static)_
