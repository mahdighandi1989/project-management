---
task_id: 44491bc6-56e8-425b-9f33-383f06329539
title: 'فیلد بلااستفاده: Task.subtasks'
type: cleanup
priority: low
...
created_at: '2026-05-15T06:07:27.006078+00:00'
updated_at: '2026-05-29T20:11:59.364733+00:00'
archived: true
...
---
[scan #2 at 2026-05-15T06:07:27.303123+00:00]
## 📋 شرح
فیلد `shell` در dataclass/model `Task` (فایل `backend/app/services/creator_engine.py`) تعریف شده ولی هرگز خوانده نمی‌شود.
...
- علت: field def
---
[scan #3 at 2026-05-15T06:41:02.803375+00:00]
## 📋 شرح
فیلد `subtasks` در dataclass/model `Task` (فایل `backend/app/services/creator_engine.py`) تعریف شده ولی هرگز خوانده نمی‌شود.
...
- علت: field 
---
[scan #4 at 2026-05-15T06:41:03.098554+00:00]
## 📋 شرح
فیلد `shell` در dataclass/model `Task` (فایل `backend/app/services/creator_engine.py`) تعریف شده ولی هرگز خوانده نمی‌شود.
...
- علت: field def
---
[scan #5 at 2026-05-15T07:42:42.934569+00:00]
## 📋 شرح
فیلد `subtasks` در dataclass/model `Task` (فایل `backend/app/services/creator_engine.py`) تعریف شده ولی هرگز خوانده نمی‌شود.
...
- علت: field 
---
[scan #6 at 2026-05-15T07:42:43.218180+00:00]
## 📋 شرح
فیلد `shell` در dataclass/model `Task` (فایل `backend/app/services/creator_engine.py`) تعریف شده ولی هرگز خوانده نمی‌شود.
...
1. تأیید شد `subtasks` در هیچ reader مصرف نمی‌شود _(verify: static)_
