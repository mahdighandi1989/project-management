---
task_id: 16f13037-6643-40a1-9a1e-9e953048d054
title: 'endpoint بک‌اند بلااستفاده: GET /file-content/{project_id}/{file_path:path}'
type: audit
priority: medium
...
created_at: '2026-05-15T06:05:57.287281+00:00'
updated_at: '2026-05-20T04:23:28.891645+00:00'
archived: true
...
---
[scan #2 at 2026-05-15T06:39:20.812151+00:00]
## 📋 شرح
endpoint `GET /file-content/{project_id}/{file_path:path}` در `backend/app/api/routes/orchestrator.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
- فایل: `backend/
---
[scan #3 at 2026-05-15T07:39:32.685139+00:00]
## 📋 شرح
endpoint `GET /file-content/{project_id}/{file_path:path}` در `backend/app/api/routes/orchestrator.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
- فایل: `backend/
---
[scan #4 at 2026-05-15T10:32:35.845753+00:00]
## 📋 شرح
endpoint `GET /file-content/{project_id}/{file_path:path}` در `backend/app/api/routes/orchestrator.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
- فایل: `backend/
---
[scan #5 at 2026-05-15T16:45:13.879070+00:00]
## 📋 شرح
endpoint `GET /file-content/{project_id}/{file_path:path}` در `backend/app/api/routes/orchestrator.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
1. مشخص شد endpoint `GET /file-content/{project_id}/{file_path:path}` در کدام دسته است (orphan/internal/deprecated) _(verify: static)_
