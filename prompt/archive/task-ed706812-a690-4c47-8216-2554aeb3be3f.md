---
task_id: ed706812-a690-4c47-8216-2554aeb3be3f
...
created_at: '2026-05-15T06:05:56.640729+00:00'
updated_at: '2026-05-20T04:23:22.418355+00:00'
archived: true
archived_at: '2026-05-17T18:15:43.078134+00:00'
target_files:
...
---
[scan #2 at 2026-05-15T06:39:19.790448+00:00]
## 📋 شرح
endpoint `GET /rankings` در `backend/app/api/routes/model_profiles.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
---
[scan #3 at 2026-05-15T07:39:31.528978+00:00]
## 📋 شرح
endpoint `GET /rankings` در `backend/app/api/routes/model_profiles.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
- علت: no frontend fetch + no re
---
[scan #4 at 2026-05-15T10:32:34.749944+00:00]
## 📋 شرح
endpoint `GET /rankings` در `backend/app/api/routes/model_profiles.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
- علت: no frontend fetch + no re
---
[scan #5 at 2026-05-15T16:45:12.464496+00:00]
## 📋 شرح
endpoint `GET /rankings` در `backend/app/api/routes/model_profiles.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
- علت: no frontend fetch + no re
---
[scan #6 at 2026-05-15T17:39:53.983442+00:00]
## 📋 شرح
endpoint `GET /rankings` در `backend/app/api/routes/model_profiles.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
