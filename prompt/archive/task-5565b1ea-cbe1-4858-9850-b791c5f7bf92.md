---
task_id: 5565b1ea-cbe1-4858-9850-b791c5f7bf92
title: 'route فرانت‌اند بلااستفاده: /model-profiles'
type: cleanup
priority: medium
...
created_at: '2026-05-15T06:05:55.711044+00:00'
updated_at: '2026-05-29T20:10:57.651000+00:00'
archived: true
...
---
[scan #2 at 2026-05-15T06:39:18.719448+00:00]
## 📋 شرح
route `/model-profiles` در فایل `` تعریف شده ولی هیچ `Link`، `router.push`، یا redirect در کدبیس به آن اشاره نمی‌کند.
...
route orphan یعن
---
[scan #3 at 2026-05-15T07:39:30.450796+00:00]
## 📋 شرح
route `/model-profiles` در فایل `` تعریف شده ولی هیچ `Link`، `router.push`، یا redirect در کدبیس به آن اشاره نمی‌کند.
...
route orphan یعن
---
[scan #4 at 2026-05-15T10:32:33.663474+00:00]
## 📋 شرح
route `/model-profiles` در فایل `` تعریف شده ولی هیچ `Link`، `router.push`، یا redirect در کدبیس به آن اشاره نمی‌کند.
...
route orphan یعن
---
[scan #5 at 2026-05-15T16:45:10.928001+00:00]
## 📋 شرح
route `/model-profiles` در فایل `` تعریف شده ولی هیچ `Link`، `router.push`، یا redirect در کدبیس به آن اشاره نمی‌کند.
...
route orphan یعن
---
[scan #6 at 2026-05-15T17:39:52.740074+00:00]
## 📋 شرح
route `/model-profiles` در فایل `` تعریف شده ولی هیچ `Link`، `router.push`، یا redirect در کدبیس به آن اشاره نمی‌کند.
...
1. تأیید شد که `/model-profiles` orphan است (هیچ Link/router.push اشاره نمی‌کند) _(verify: static)_
