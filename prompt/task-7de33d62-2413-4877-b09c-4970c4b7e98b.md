...
updated_at: '2026-05-31T09:07:09.948228+00:00'
target_files:
...
1. تمامی session های ساخته شده با SessionLocal() در finally بسته شوند
2. هیچ warning ای در log مربوط به unclosed session دیده نشود
3. endpoint run_analysis_stream بعد از ۱۰۰ درخواست همزمان بدون خطا کار کند
