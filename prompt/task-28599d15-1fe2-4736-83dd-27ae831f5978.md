---
task_id: 28599d15-1fe2-4736-83dd-27ae831f5978
title: duplicate model profile endpoints در models.py و model_profiles.py
type: refactor
priority: high
...
created_at: '2026-05-31T09:07:44.984915+00:00'
updated_at: '2026-05-31T09:07:44.984918+00:00'
---

# duplicate model profile endpoints در models.py و model_profiles.py

## Raw Idea

دو فایل models.py و model_profiles.py هر دو endpoint برای دریافت پروفایل مدل‌ها دارند. models.py در خط 266-286 یک endpoint /models/profiles دارد که از model_profiler استفاده می‌کند، در حالی که model_profiles.py یک endpoint /api/models/profiles دارد که از دیتابیس (AIProfile) استفاده می‌کند. این دوگانگی باعث می‌شود frontend دو مسیر مختلف برای یک قابلیت داشته باشد و داده‌های ناساز
