...
updated_at: '2026-05-31T09:07:31.576962+00:00'
target_files:
...
1. هیچ endpointای مستقیماً SessionLocal() نمی‌سازد
2. تمام endpointها از Depends(get_db) استفاده می‌کنند
3. background tasks از context manager برای session استفاده می‌کنند
4. هیچ connection leak در لاگ
