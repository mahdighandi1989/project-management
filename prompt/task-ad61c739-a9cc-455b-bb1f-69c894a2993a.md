...
updated_at: '2026-06-14T09:39:51.717017+00:00'
target_files:
...
1. فراخوانی /github/check و /github/import بدون توکن معتبر با 401 رد شود
2. use_global_token=true فقط برای کاربر/admin احرازشده توکن سراسری را برمی‌گرداند
3. url با host غیر github.com در import رد شود (whitelist)
