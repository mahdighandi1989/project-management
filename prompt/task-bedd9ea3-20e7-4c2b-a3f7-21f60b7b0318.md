...
updated_at: '2026-06-14T09:41:05.100556+00:00'
target_files:
...
---
[scan #3 at 2026-06-07T09:29:20.467502+00:00]
## 📋 شرح
در `backend/app/api/routes/external_prompts.py` (line 374) یک exception handler خاموش (مثل `except: pass`) در مسیر اصلی کد پیدا شد.
...
silent failure خطرناک‌ترین bug است — کد به‌نظر کار می‌کند ولی در شرای
---
[scan #4 at 2026-06-14T09:41:05.100546+00:00]
## 📋 شرح
در `backend/app/api/routes/external_prompts.py` (line 374) یک exception handler خاموش (مثل `except: pass`) در مسیر اصلی کد پیدا شد.
