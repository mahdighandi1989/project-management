...
updated_at: '2026-06-07T09:29:38.790858+00:00'
target_files:
...
2. تست‌هایی برای رندر شدن اولیه و نمایش وضعیت API Keys. _(verify: static)_
3. تست‌هایی برای سناریوهای ورود کلید و ذخیره آن. _(verify: static)_
4. تست‌هایی برای نمایش پیام‌های بازخورد (success/error). _(verify: static)_
