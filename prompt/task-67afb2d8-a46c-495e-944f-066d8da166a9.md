...
updated_at: '2026-06-07T09:28:58.500992+00:00'
target_files:
...
2. تست‌های یکپارچه‌سازی برای هر سه endpoint اصلی (secrets, licenses, full-report) اضافه شوند. _(verify: static)_
3. تست‌ها شامل موارد لبه (edge cases) مانند پروژه‌های خالی یا فایل‌های خاص باشند. _(verify: static)_
4. تست‌ها تأیید کنند که نتایج اسکن به درستی در دیتابیس ذخیره می‌شوند. _(verify: static)_
