...
updated_at: '2026-05-31T09:09:14.988559+00:00'
target_files:
...
1. مقدار به constant با نام معنادار منتقل شد
2. comment توضیحی برای انتخاب این مقدار اضافه شد
3. اگر در چند جا تکرار می‌شد، همه به یک منبع وصل شدند
