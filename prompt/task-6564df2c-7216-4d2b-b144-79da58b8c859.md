...
updated_at: '2026-06-07T09:29:38.107573+00:00'
target_files:
...
3. Payloadهای XSS تزریق شده در فیلدهای بک‌اند در مرورگر اجرا نمی‌شوند. _(verify: static)_
4. تست‌های واحد/E2E جدید برای تأیید جلوگیری از XSS اضافه می‌شوند. _(verify: static)_
