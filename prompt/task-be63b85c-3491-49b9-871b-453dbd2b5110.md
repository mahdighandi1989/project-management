...
updated_at: '2026-06-07T09:29:00.488780+00:00'
target_files:
...
2. All API calls to `/api/models/profiles` are correctly routed to `backend/app/api/routes/model_profiles.py`. _(verify: static)_
3. The `frontend/src/app/models/page.tsx` and `frontend/src/app/model-profiles/page.tsx` correctly display model data without conflicts. _(verify: static)_
