---
task_id: 28fbf121-f941-4dad-97cd-cb1ad6fc6290
title: تکرار منطق ذخیرهٔ API key در فایل .env در دو endpoint settings (update_api_keys و update_deploy_keys)
type: refactor
priority: medium
...
created_at: '2026-06-14T09:41:07.392184+00:00'
updated_at: '2026-06-14T09:42:46.824007+00:00'
---

# تکرار منطق ذخیرهٔ API key در فایل .env در دو endpoint settings (update_api_keys و update_deploy_keys)

## Raw Idea

بلوک کامل خواندن/نوشتن فایل .env به‌صورت verbatim در دو endpoint تکرار شده است: در update_api_keys (settings.py خط 201-219) و در update_deploy_keys (خط 330-348). هر دو همان منطق را دارند: محاسبهٔ env_file path با چهار os.path.dirname تو در تو، خواندن خطوط موجود، update، و بازنویسی. این duplicated logic باعث می‌شود اگر فرمت .env تغییر کند یا bug در parse باشد باید در دو جا اصلاح شود. علاوه بر این، نوشتن همزمان دو endpoint روی همان فایل .env
