...
updated_at: '2026-06-07T09:28:59.135503+00:00'
target_files:
...
2. درخواست‌های بدون `X-Admin-Token` معتبر به این مسیرها، خطای 401 Unauthorized برمی‌گردانند. _(verify: static)_
3. مستندات مربوط به استقرار شامل دستورالعمل‌هایی برای پیکربندی `ADMIN_TOKEN` می‌شود. _(verify: static)_
