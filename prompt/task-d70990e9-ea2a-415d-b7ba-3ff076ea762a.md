...
updated_at: '2026-06-07T09:29:19.856227+00:00'
target_files:
...
1. Database refresh failures are logged as errors and prevent further processing with stale data. _(verify: static)_
2. The system's behavior under concurrent updates to `project.issues_found` is defined and tested (e.g., using a version column or explicit locking). _(verify: static)_
3. No `issues_found` data is lost or corrupted due to race conditions. _(verify: static)_
