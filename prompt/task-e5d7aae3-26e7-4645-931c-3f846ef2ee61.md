...
updated_at: '2026-06-14T09:39:51.356462+00:00'
target_files:
...
1. هدر Access-Control-Allow-Origin: * از پاسخ run-analysis-stream حذف شده باشد
2. درخواست cross-origin از origin خارج از whitelist با CORS مسدود شود
3. frontend same-origin همچنان بتواند استریم را دریافت کند
