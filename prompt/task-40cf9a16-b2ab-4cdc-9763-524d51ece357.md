...
updated_at: '2026-06-07T09:29:38.471242+00:00'
target_files:
- backend/app/main.py
- backend/app/main.py
---
...
1. `CORS_ORIGINS` در محیط تولید به دامنه‌های خاص و مورد اعتماد محدود شده است. _(verify: static)_
2. در محیط توسعه، `CORS_ORIGINS` اجازه دسترسی از `localhost` و/یا `*` را می‌دهد. _(verify: static)_
3. مستندات استقرار شامل دستورالعمل‌هایی برای پیکربندی `CORS_ORIGINS` است. _(verify: static)_
